...
def main() -> None:
    ...
    parser.add_argument('-source', type = pathlib.Path, required = True, help = 'The folder containing TXT files')
    ...
    parser.add_argument('-control', type = int, default = 1024, help = 'The rough amount of ram (in Mb) used by the control structure')
