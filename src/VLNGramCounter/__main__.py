...
def main() -> None:
    ...
    parser.add_argument('-chunk_size', type = int, default = 1000000, help = 'The amount of items in used by the control structure before chunking')
    ...
    _print_args(args)
    set = settings(args.source, args.dest, args.length, args.chunk_size, args.include, args.exclude, args.cutoff, args.top, args.keep_case, args.keep_punct)
